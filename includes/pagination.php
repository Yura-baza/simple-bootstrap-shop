...
if($_GET['entry_search'] == NULL && $_GET['filter_category'] == NULL && $_GET['filter_title'] == NULL && $_GET['page'] == NULL) {
...
// If IS entry_search request, filter_category request, filter_title request and NOT single page request
if($_GET['entry_search'] != NULL || $_GET['filter_category'] != NULL || $_GET['filter_title'] != NULL && $_GET['page'] == NULL) {
